...
namespace CSV_SPACE
{
	...
	{
		public static string filePath="Assets/Excel2CSV/CSV/Item.csv";
		public string ID { get; private set; }
		public string CN { get; private set; }
		public string EN { get; private set; }
		public string Effect { get; private set; }

		 public static Dictionary<string, ItemCSV> Load(string csvFilePath="Assets/Excel2CSV/CSV/Item.csv")
		{
